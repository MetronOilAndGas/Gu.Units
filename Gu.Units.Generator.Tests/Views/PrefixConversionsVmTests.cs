namespace Gu.Units.Generator.Tests.Views
{
    ...
    public class PrefixConversionsVmTests
    {
        ...
        public void SetBaseUnitToMetres()
        {
            ...
            var expected = new[]
            {
                new PrefixConversionVm(settings.Milli, settings.Metres),
                new PrefixConversionVm(settings.Kilo, settings.Metres)
            };
        ...
        public void SetBaseUnitToKilograms()
        {
            ...
            var expected = new[]
            {
                new PrefixConversionVm(settings.Milli, settings.Grams),
