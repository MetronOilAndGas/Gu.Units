namespace Gu.Units.Generator.Tests.Descriptors
{
    ...
    public class UnitPartsTests
    {
        ...
        {
            var up1 = new UnitParts(this._settings.Metres, UnitAndPower.Create(this._settings.Metres, 1));
            var up2 = new UnitParts(this._settings.Seconds, UnitAndPower.Create(this._settings.Seconds, -1));
            var prod = up1 * up2;
        ...
        {
            var up1 = new UnitParts(this._settings.Metres, UnitAndPower.Create(this._settings.Metres, 1));
            var up2 = new UnitParts(this._settings.Metres, UnitAndPower.Create(this._settings.Metres, 1));
            var prod = up1 * up2;
        ...
        {
            var farads = new UnitParts(null, UnitAndPower.Create(this._settings.Coloumbs, 1), UnitAndPower.Create(this._settings.Volts, -1));
