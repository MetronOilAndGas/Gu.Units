namespace Gu.Units
{
    ...
    public partial struct Volume : IComparable<Volume>, IEquatable<Volume>, IFormattable, IXmlSerializable, IQuantity<LengthUnit, I3>, IQuantity<VolumeUnit>
    {
        ...
        {
            var quantityFormat = FormatParser<VolumeUnit>.GetOrCreate(string.Empty, this.SiUnit);
            return this.ToString(quantityFormat, null);
        }

        public string ToString(string format)
        {
            var quantityFormat = FormatParser<VolumeUnit>.GetOrCreate(format);
            return ToString(quantityFormat, null);
        }

        public string ToString(IFormatProvider provider)
        {
            var quantityFormat = FormatParser<VolumeUnit>.GetOrCreate(string.Empty, SiUnit);
        ...
        private string ToString(QuantityFormat<VolumeUnit> format, IFormatProvider formatProvider)
        {
