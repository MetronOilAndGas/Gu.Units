namespace Gu.Units
{
    ...
    public partial struct Force : IComparable<Force>, IEquatable<Force>, IFormattable, IXmlSerializable, IQuantity<MassUnit, I1, LengthUnit, I1, TimeUnit, INeg2>, IQuantity<ForceUnit>
    {
        ...
        /// <summary>
        /// Compares this instance to a specified <see cref="MathNet.Spatial.Units.Force"/> object and returns an integer that indicates whether this <see cref="quantity"/> is smaller than, equal to, or greater than the <see cref="MathNet.Spatial.Units.Force"/> object.
        /// </summary>
        /// <returns>
        ...
        /// 
        /// </returns>
        /// <param name="quantity">An instance of <see cref="MathNet.Spatial.Units.Force"/> object to compare to this instance.</param>
