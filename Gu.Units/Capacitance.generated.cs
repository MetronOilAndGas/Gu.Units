namespace Gu.Units
{
    ...
    public partial struct Capacitance : IComparable<Capacitance>, IEquatable<Capacitance>, IFormattable, IXmlSerializable, IQuantity<TimeUnit, I4, CurrentUnit, I2, MassUnit, INeg1, LengthUnit, INeg2>, IQuantity<CapacitanceUnit>
    {
        ...
        /// <summary>
        /// Compares this instance to a specified <see cref="MathNet.Spatial.Units.Capacitance"/> object and returns an integer that indicates whether this <see cref="quantity"/> is smaller than, equal to, or greater than the <see cref="MathNet.Spatial.Units.Capacitance"/> object.
        /// </summary>
        /// <returns>
        ...
        /// 
        /// </returns>
        /// <param name="quantity">An instance of <see cref="MathNet.Spatial.Units.Capacitance"/> object to compare to this instance.</param>
