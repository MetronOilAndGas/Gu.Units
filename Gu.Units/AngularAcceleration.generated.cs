namespace Gu.Units
{
    ...
    /// </summary>
    [Serializable, TypeConverter(typeof(AngularAccelerationTypeConverter))]
    public partial struct AngularAcceleration : IComparable<AngularAcceleration>, IEquatable<AngularAcceleration>, IFormattable, IXmlSerializable, IQuantity<AngleUnit, I1, TimeUnit, INeg2>, IQuantity<AngularAccelerationUnit>
    {
        ...
        /// <summary>
        /// Compares this instance to a specified <see cref="MathNet.Spatial.Units.AngularAcceleration"/> object and returns an integer that indicates whether this <see cref="quantity"/> is smaller than, equal to, or greater than the <see cref="MathNet.Spatial.Units.AngularAcceleration"/> object.
        /// </summary>
        /// <returns>
        ...
        /// 
        /// </returns>
        /// <param name="quantity">An instance of <see cref="MathNet.Spatial.Units.AngularAcceleration"/> object to compare to this instance.</param>
