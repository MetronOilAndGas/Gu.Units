namespace Gu.Units
{
    ...
    public partial struct VolumetricFlow : IComparable<VolumetricFlow>, IEquatable<VolumetricFlow>, IFormattable, IXmlSerializable, IQuantity<LengthUnit, I3, TimeUnit, INeg1>, IQuantity<VolumetricFlowUnit>
    {
        ...
        /// <summary>
        /// Compares this instance to a specified <see cref="MathNet.Spatial.Units.VolumetricFlow"/> object and returns an integer that indicates whether this <see cref="quantity"/> is smaller than, equal to, or greater than the <see cref="MathNet.Spatial.Units.VolumetricFlow"/> object.
        /// </summary>
        /// <returns>
        ...
        /// 
        /// </returns>
        /// <param name="quantity">An instance of <see cref="MathNet.Spatial.Units.VolumetricFlow"/> object to compare to this instance.</param>
