namespace Gu.Units
{
    ...
    public partial struct Mass : IComparable<Mass>, IEquatable<Mass>, IFormattable, IXmlSerializable, IQuantity<MassUnit, I1>, IQuantity<MassUnit>
    {
        ...
        /// <summary>
        /// Compares this instance to a specified <see cref="MathNet.Spatial.Units.Mass"/> object and returns an integer that indicates whether this <see cref="quantity"/> is smaller than, equal to, or greater than the <see cref="MathNet.Spatial.Units.Mass"/> object.
        /// </summary>
        /// <returns>
        ...
        /// 
        /// </returns>
        /// <param name="quantity">An instance of <see cref="MathNet.Spatial.Units.Mass"/> object to compare to this instance.</param>
