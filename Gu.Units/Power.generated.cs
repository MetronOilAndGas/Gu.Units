namespace Gu.Units
{
    ...
    public partial struct Power : IComparable<Power>, IEquatable<Power>, IFormattable, IXmlSerializable, IQuantity<MassUnit, I1, LengthUnit, I2, TimeUnit, INeg3>, IQuantity<PowerUnit>
    {
        ...
        {
            var quantityFormat = FormatParser<PowerUnit>.GetOrCreate(string.Empty, this.SiUnit);
            return this.ToString(quantityFormat, null);
        }

        public string ToString(string format)
        {
            var quantityFormat = FormatParser<PowerUnit>.GetOrCreate(format);
            return ToString(quantityFormat, null);
        }

        public string ToString(IFormatProvider provider)
        {
            var quantityFormat = FormatParser<PowerUnit>.GetOrCreate(string.Empty, SiUnit);
        ...
        {
            var quantityFormat = FormatParser<PowerUnit>.GetOrCreate(string.Empty, unit);
            return ToString(quantityFormat, null);
        }

        public string ToString(string valueFormat, PowerUnit unit)
        {
            var quantityFormat = FormatParser<PowerUnit>.GetOrCreate(valueFormat, unit);
            return ToString(quantityFormat, null);
        }

        public string ToString(string valueFormat, IFormatProvider formatProvider, PowerUnit unit)
        {
            var quantityFormat = FormatParser<PowerUnit>.GetOrCreate(valueFormat, unit);
            return ToString(quantityFormat, formatProvider);
        }

        private string ToString(QuantityFormat<PowerUnit> format, IFormatProvider formatProvider)
        {
