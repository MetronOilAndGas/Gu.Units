namespace Gu.Units
{
    ...
    public partial struct Resistance : IComparable<Resistance>, IEquatable<Resistance>, IFormattable, IXmlSerializable, IQuantity<MassUnit, I1, LengthUnit, I2, TimeUnit, INeg3, CurrentUnit, INeg2>, IQuantity<ResistanceUnit>
    {
        ...
        {
            var quantityFormat = FormatParser<ResistanceUnit>.GetOrCreate(string.Empty, this.SiUnit);
            return this.ToString(quantityFormat, null);
        }

        public string ToString(string format)
        {
            var quantityFormat = FormatParser<ResistanceUnit>.GetOrCreate(format);
            return ToString(quantityFormat, null);
        }

        public string ToString(IFormatProvider provider)
        {
            var quantityFormat = FormatParser<ResistanceUnit>.GetOrCreate(string.Empty, SiUnit);
        ...
        {
            var quantityFormat = FormatParser<ResistanceUnit>.GetOrCreate(string.Empty, unit);
            return ToString(quantityFormat, null);
        }

        public string ToString(string valueFormat, ResistanceUnit unit)
        {
            var quantityFormat = FormatParser<ResistanceUnit>.GetOrCreate(valueFormat, unit);
            return ToString(quantityFormat, null);
        }

        public string ToString(string valueFormat, IFormatProvider formatProvider, ResistanceUnit unit)
        {
            var quantityFormat = FormatParser<ResistanceUnit>.GetOrCreate(valueFormat, unit);
            return ToString(quantityFormat, formatProvider);
        }

        private string ToString(QuantityFormat<ResistanceUnit> format, IFormatProvider formatProvider)
        {
