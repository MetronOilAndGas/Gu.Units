namespace Gu.Units
{
    ...
    public partial struct Pressure : IComparable<Pressure>, IEquatable<Pressure>, IFormattable, IXmlSerializable, IQuantity<MassUnit, I1, LengthUnit, INeg1, TimeUnit, INeg2>, IQuantity<PressureUnit>
    {
        ...
        /// <summary>
        /// Compares this instance to a specified <see cref="MathNet.Spatial.Units.Pressure"/> object and returns an integer that indicates whether this <see cref="quantity"/> is smaller than, equal to, or greater than the <see cref="MathNet.Spatial.Units.Pressure"/> object.
        /// </summary>
        /// <returns>
        ...
        /// 
        /// </returns>
        /// <param name="quantity">An instance of <see cref="MathNet.Spatial.Units.Pressure"/> object to compare to this instance.</param>
